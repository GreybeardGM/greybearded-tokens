...
- Keep comments and documentation comments in English; user-facing localization strings may remain localized.
- Prefer concise, readable code and remove redundant lines when it does not reduce clarity or behavior.
